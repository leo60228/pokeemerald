...
#define STARTER_MON_COUNT_JOHTO      2
#define STARTER_MON_COUNT_SINNOH     3
#define STARTER_MON_COUNT_UNOVA      4
#define STARTER_MON_COUNT_KALOS      5
#define STARTER_MON_COUNT_ALOLA      6
#define STARTER_MON_COUNT_GALAR      7
#define STARTER_MON_COUNT_PALDEA     8
