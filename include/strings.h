...
extern const u8 gText_Pie_LevelCapExplain[];
extern const u8 gText_Pie_DynasticLevelCap[];
extern const u8 gText_Pie_DynasticMode[];
extern const u8 gText_Pie_KaizoMode[];
extern const u8 gText_Pie_Documents[];
extern const u8 gText_Pie_Kanto[];
extern const u8 gText_Pie_Johto[];
extern const u8 gText_Pie_Hoenn[];
extern const u8 gText_Pie_Sinnoh[];
extern const u8 gText_Pie_Unova[];
extern const u8 gText_Pie_Kalos[];
extern const u8 gText_Pie_Alola[];
extern const u8 gText_Pie_Galar[];
extern const u8 gText_Pie_Paldea[];
extern const u8 gText_Pie_WhichRegion[];
extern const u8 gText_Pie_Regions[];
...
extern const u8 gText_BirchDynasticMode[];
extern const u8 gText_BirchKaizoMode[];
extern const u8 gText_BirchKanto[];
extern const u8 gText_BirchJohto[];
extern const u8 gText_BirchHoenn[];
extern const u8 gText_BirchSinnoh[];
extern const u8 gText_BirchUnova[];
extern const u8 gText_BirchKalos[];
extern const u8 gText_BirchAlola[];
extern const u8 gText_BirchGalar[];
extern const u8 gText_BirchPaldea[];
